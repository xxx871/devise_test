...
ActiveRecord::Schema[7.0].define(version: 2024_05_16_053458) do
  ...
  create_table "gender_hith_notes", force: :cascade do |t|
    t.bigint "gender_id", null: false
    t.bigint "note_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gender_id"], name: "index_gender_hith_notes_on_gender_id"
    t.index ["note_id"], name: "index_gender_hith_notes_on_note_id"
  end
  ...
  create_table "user_high_notes", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_user_high_notes_on_user_id"
  end
  ...
  create_table "user_low_notes", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_user_low_notes_on_user_id"
  end
  ...
  add_foreign_key "gender_hith_notes", "genders"
  add_foreign_key "gender_hith_notes", "notes"
